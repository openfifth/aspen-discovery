...
function getUpdates26_05_00(): array {
	...
	return [
		...
		//chloe
		'add_bookings_to_library' => [
			'title' => 'Add Bookings Toggle to Library',
			'description' => 'Adds enableBookings flag to the library table to allow per-library-system control of the Koha Bookings integration.',
			'continueOnError' => false,
			'sql' => [
