...
function getAspenEventWaitingListUpdates() {
	return [
		...
		'add_waitingListNumberOfSeats_to_events' => [
			...
			'sql' => [
				'ALTER TABLE event ADD COLUMN waitingListNumberOfSeats SMALLINT UNSIGNED DEFAULT NULL',
				'ALTER TABLE event_instance ADD COLUMN waitingListNumberOfSeats SMALLINT UNSIGNED DEFAULT NULL',
			],
		], // add_waitingListNumberOfSeats_to_events
