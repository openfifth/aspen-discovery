...
class HeyCentricUrlParameterSetting extends DataObject {
	...
	static function getObjectStructure($context = ''): array {
		...
		$additionalFineFields = $catalogDriver->hasAdditionalFields() ? $catalogDriver->getAdditionalFieldNames('accountlines', null) : null;
		$additionalDebitTypeFields = $catalogDriver->hasAdditionalFields() ? $catalogDriver->getAdditionalFieldNames('account_debit_types', null) : null;
		$additionalLibraryBranchFields = $catalogDriver->hasAdditionalFields() ? $catalogDriver->getAdditionalFieldNames('branches', null) : null;
