...
- Remove the autoclose feature from the campaign toast notifications so that users must manually dismiss them to better meet accessibility needs. (DIS-1574) (*AB*)
- Update campaign toast messages to refer to the campaign to which the milestone relates. (DIS-1576) (*AB*)
...
- Add classes to make selection for targeted CSS easier. (DIS-1582) (*AB*)
