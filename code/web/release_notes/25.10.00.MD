...
- When a title is in transit from outside the library's hold group, show that it is being delivered from another library and prevent it from being cancelled or suspended. (DIS-1466) (*MDN*)
- Allow HTML in Local ILL Request Form intro text and Fee Information Text. (DIS-1467) (*MDN*)
...
- Correct parsing of test subdomains, i.e. 100t.catalog.library.org and 100x.catalog.library.org. (DIS-1455) (*MDN*)
- Correct incorrectly reported error that an indexer had no completed entries within 24 hours. (DIS-1472) (*MDN*)
...
- Fixed error when viewing checkouts or search results for items with missing status information. (DIS-1468) (*LS*)
