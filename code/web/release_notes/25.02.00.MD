...
//alexander
### Holds Updates
- Added the ability for users to filter the display by removing the holds of selected linked users and by filtering the display by selected holds. (DIS-219) (*AB*)
- Export holds will take account of the new filters, exporting only the holds on the screen. (DIS-219) (*AB*)
### Indexing Updates
