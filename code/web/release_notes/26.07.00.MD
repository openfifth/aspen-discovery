...
- For Koha also load returned checkouts whenever a patron accesses their Reading History page or when the UpdateReadingHistory cron job runs ([DIS-2552](https://aspen-discovery.atlassian.net/browse/DIS-2552)) (*CZ*)
- Limit the checkouts loaded to those between the last and present history reload ([DIS-2552](https://aspen-discovery.atlassian.net/browse/DIS-2552)) (*CZ*)
