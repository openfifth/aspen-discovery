...
- Add a new option for "Display of Hold and Copy Counts" to "Show holdable copies without hold counts". (DIS-1473) (*MDN*)
...
- In Holdings Summary, add an option to show available copies for a record without hold in Library Settings. (DIS-1473) (*KK*)
<div markdown="1" class="settings">
