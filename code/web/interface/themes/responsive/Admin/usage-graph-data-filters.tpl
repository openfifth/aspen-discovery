	...
	<form>
		<div class='form-group'>
			...
			<select name='timeframe' id='timeframe' class='form-control' onchange=toggleCustomPeriodInputFieldDisplay()>
				<option value='day'>{translate text='Day' isAdminFacing=true}</option>
				<option value='month'>{translate text='Month' isAdminFacing=true}</option> 
				<option value='year'>{translate text='Year' isAdminFacing=true}</option>
