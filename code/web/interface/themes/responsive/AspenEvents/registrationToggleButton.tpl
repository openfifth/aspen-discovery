{strip}
	{if !empty($loggedIn)}
		<button id="aspen-events-toggle-registration-button-{$userId}" type="button" class="btn btn-primary" onclick="return AspenDiscovery.Account.toggleUserEventRegistration('{$eventSourceId}');">
			{if $isRegistered}
