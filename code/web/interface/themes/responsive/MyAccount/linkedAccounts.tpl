			...
			{else}
				{if $profile->disableAccountLinking==0 && $linkSetting != 3}
					...
					{if $linkSetting !=2}
						...
						<p>{translate text="The following accounts can view checkout, native Aspen events, and hold information from this account.  If someone is viewing your account that you do not want to have access, please contact library staff." isPublicFacing=true}</p>
						<ul>
