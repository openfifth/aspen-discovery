{strip}
	...
	<div id="page-content" class="col-xs-12">
		...
		<div id="loginFormWrapper">
			...
			<input type="submit" name="submit" value="{translate text="Start" isPublicFacing=true}" id="loginFormEnroll" class="btn btn-primary" onclick="return AspenDiscovery.Account.show2FAEnrollment(true, '{$authMethod}');">
			&nbsp;
