				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Active Users" isAdminFacing=true}
							{' '}
							<a href="/EBSCOhost/UsageGraphs?stat=activeUsers{if !empty($subSection)}&subSection={$subSection}{/if}&instance={$selectedInstance}" title="{translate text="Show Unique Logged In Users Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a>
						</h2>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Number of Records Viewed" isAdminFacing=true}
							{' '}
							<a href="/EBSCOhost/UsageGraphs?stat=numViews{if !empty($subSection)}&subSection={$subSection}{/if}&instance={$selectedInstance}" title="{translate text="Show Total Views Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a>
						</h2>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Number of Records Clicked" isAdminFacing=true}
							{' '}
							<a href="/EBSCOhost/UsageGraphs?stat=numRecordsUsed{if !empty($subSection)}&subSection={$subSection}{/if}&instance={$selectedInstance}" title="{translate text="Show Unique Records Used (clicked on) Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a>
						</h2>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Total Clicks" isAdminFacing=true}
							{' '}
							<a href="/EBSCOhost/UsageGraphs?stat=numClicks{if !empty($subSection)}&subSection={$subSection}{/if}&instance={$selectedInstance}" title="{translate text="Show Total Clicks Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a>
						</h2>
					</div>
				</div>
				<div class="row">
