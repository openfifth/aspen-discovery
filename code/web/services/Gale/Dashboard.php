...
class Gale_Dashboard extends Admin_Dashboard {
	function launch() {
		global $interface;

		$instanceName = $this->loadInstanceInformation('GaleRecordUsage');
		$this->loadDates();
		...
		$this->display('dashboard.tpl', 'Gale Dashboard');
	}
	...
	public function getRecordStats($instanceName, $month, $year): array {
		...
		$usage->selectAdd('COUNT(galeId) as recordsUsed');
	...
	function getBreadcrumbs(): array {
		...
		$breadcrumbs[] = new Breadcrumb('/Gale/Dashboard', 'Gale Usage Dashboard');
		return $breadcrumbs;
	}
